...
final ThemeData blueTheme = ThemeData(
  ...
  primaryColor: const Color(0xff1e90d0),
  primaryColorLight: const Color(0xffcce6ff),
  primaryColorDark: const Color(0xff004e99),
  ...
  toggleableActiveColor: const Color(0xff004e99),
  ...
  floatingActionButtonTheme: const FloatingActionButtonThemeData(backgroundColor: Color(0xff1e90d0)),

  dialogBackgroundColor: const Color(0xffffffff),

  indicatorColor: const Color(0xff1e90d0), //XX
  hintColor: const Color(0x8a000000), //xx
  errorColor: const Color(0xff004e99),
  buttonTheme: const ButtonThemeData(
    ...
    colorScheme: ColorScheme(
      primary: Color(0xff004e99),
      secondary: Color(0xff1e90d0),
      surface: Color(0xffffffff),
      background: Color(0xffcce6ff),
      error: Color(0xff004e99),
